        ...
        {formOpen && (
          <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-4">
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => { setFormOpen(false); setForm(EMPTY_FORM); }}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-lg text-slate-600 hover:text-red-400 hover:bg-red-950/30 transition-colors"
                      >
                        {deletingId === p.id
